<script lang="ts">
    import {Themes, themeStore, toggleTheme} from "../src/app.ts";
    ...
    themeStore.subscribe(t => {
        theme = t
        tooltip = theme === Themes.Light ? "make it night" : "make it day"
    })
</script>


<button class="parent" on:click={toggleTheme} style={style} tooltip={tooltip}>
